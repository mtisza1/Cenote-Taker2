...
if str(args.HMM_DB) == "True":
    ...
    subprocess.call(['wget', '--directory-prefix=' + str(cenote_script_path), 'https://zenodo.org/record/4960186/files/hmmscan_DBs.tgz'])
