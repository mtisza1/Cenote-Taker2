...
if str(args.HMM_DB) == "True":
    ...
    subprocess.call(['wget', '--directory-prefix=' + str(cenote_script_path), 'https://zenodo.org/record/4581802/files/hmmscan_DBs.tgz'])
