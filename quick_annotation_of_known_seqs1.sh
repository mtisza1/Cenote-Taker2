...
for nucl_fa in $known_fastas ; do
	...
	blastp -evalue 1e-10 -num_descriptions 5 -num_threads 56 -num_alignments 1 -db /fdb/blastdb/nr -query ${nucl_fa%.fna}.rotate.AA.sorted.fasta -out ${nucl_fa%.known_species.fna}.rotate.blastp.out ;
